...
Generated: 2026-08-21T09:27:30+09:00
...
- Profile source observations: 822
...
- `tdl_fantasyland_cinderella_fairy_tale_hall` — シンデレラのフェアリーテイル・ホール: no usable samples in 夕食後, 閉園前
- `tdl_fantasyland_its_a_small_world` — イッツ・ア・スモールワールド: no usable samples in 閉園前
- `tdl_fantasyland_mickeys_philharmagic` — ミッキーのフィルハーマジック: no usable samples in 昼前, 夕食前, 閉園前
- `tdl_fantasyland_peter_pans_flight` — ピーターパン空の旅: no usable samples in 閉園前
- `tdl_fantasyland_pinocchios_daring_journey` — ピノキオの冒険旅行: no usable samples in 昼前, 閉園前
...
- `tdl_westernland_country_bear_theater` — カントリーベア・シアター: no usable samples in 昼前, 昼過ぎ, ショー前後, 夕食前, 夕食後, 閉園前
...
- Profile source observations: 1045
...
- `tds_ac_a_003` — シンドバッド・ストーリーブック・ヴォヤッジ: no usable samples in 夕食後, 閉園前
...
- `tds_mh_a_001` — ヴェネツィアン・ゴンドラ: no usable samples in 開園直後, 昼前, 昼過ぎ, 夕食後, 閉園前
- `tds_mi_a_002` — センター・オブ・ジ・アース: no usable samples in 昼前
